...
def run_abba_baba(dir):
	...
	angsd_command = "angsd -doAbbababa 1 -doCounts 1 -baq 1 -ref {} -useLast 1 -bam bam.filelist -out out -blockSize 1000000 -minMapQ 30 -minQ 30 -only_proper_pairs 1 -remove_bads 1 -uniqueOnly 1 -nThreads {}".format(reference_genome, threads)
